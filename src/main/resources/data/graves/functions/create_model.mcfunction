summon minecraft:armor_stand ~ ~ ~ {Tags:["graves.marker","graves.model","graves.new"],Marker:1b,Invisible:1b,NoGravity:1b,Invulnerable:1b,ArmorBlocks:[{},{},{},{id:"minecraft:light",Count:1b,tag:{gravesData:{}}}],Air:32767s}
