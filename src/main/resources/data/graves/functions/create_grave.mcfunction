...
summon minecraft:armor_stand ~ ~ ~ {Tags:["graves.marker","graves.hitbox","graves.new"],Invisible:1b,NoGravity:1b,Invulnerable:1b,Small:1b,DisabledSlots:256,HandItems:[{id:"hmh2:heart",Count:1b,tag:{gravesData:{items:[]}}},{id:"hmh2:rose",Count:2b,tag:{gravesData:{}}}],Pose:{RightArm:[-90.0f,0.0f,27.0f],LeftArm:[-90.0f,0.0f,-27.0f],Head:[0.0f,0.0f,0.0f]},Silent:1b}
