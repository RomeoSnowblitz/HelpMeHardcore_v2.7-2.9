...
public class ModPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> CORK_OAK_PLACED = PlacedFeatures.register("cork_oak_placed", ModConfiguredFeatures.CORK_OAK_SPAWN, VegetationPlacedFeatures.modifiers(PlacedFeatures.createCountExtraModifier(1, 0.1f, 0 )));
    ...
    public static final RegistryEntry<PlacedFeature> STRAWBERRY_BUSH = PlacedFeatures.register("strawberry_bush", ModConfiguredFeatures.STRAWBERRY_BUSH, RarityFilterPlacementModifier.of(4), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
    ...
    public static final RegistryEntry<PlacedFeature> DIABASE = PlacedFeatures.register("diabase", ModConfiguredFeatures.DIABASE, ModOreFeatures.modifiersWithCount(64, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(1), YOffset.aboveBottom(3))));
    ...
    public static final RegistryEntry<PlacedFeature> LIFE_ORE_PLACED = PlacedFeatures.register("life_ore_placed", ModConfiguredFeatures.LIFE_ORE, ModOreFeatures.modifiersWithCount(10, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(0), YOffset.aboveBottom(128))));
    public static final RegistryEntry<PlacedFeature> LIMESTONE = PlacedFeatures.register("limestone", ModConfiguredFeatures.LIMESTONE, ModOreFeatures.modifiersWithCount(32, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(64), YOffset.aboveBottom(256))));
    ...
    public static final RegistryEntry<PlacedFeature> SHALE = PlacedFeatures.register("shale", ModConfiguredFeatures.SHALE, ModOreFeatures.modifiersWithCount(64, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(128), YOffset.aboveBottom(320))));
    ...
    public static final RegistryEntry<PlacedFeature> EMERALD_GEODE_PLACED = PlacedFeatures.register("emerald_geode_placed",
            ModConfiguredFeatures.EMERALD_GEODE, RarityFilterPlacementModifier.of(42),
