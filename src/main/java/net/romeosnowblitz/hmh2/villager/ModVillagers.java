...
public class ModVillagers {
    ...
    public static final VillagerProfession MYSTERIOUS_ALCHEMIST = registerProfession("mysterious_alchemist",
            RegistryKey.of(Registries.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(Hmh2.MOD_ID, "mysterious_poi")));

    public static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(Hmh2.MOD_ID, name),
