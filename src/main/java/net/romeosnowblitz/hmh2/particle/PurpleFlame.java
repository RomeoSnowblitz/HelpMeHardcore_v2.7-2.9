...
public class PurpleFlame extends AbstractSlowingParticle {
    PurpleFlame(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class SmallFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            PurpleFlame flameParticle = new PurpleFlame(clientWorld, d, e, f, g, h, i);
