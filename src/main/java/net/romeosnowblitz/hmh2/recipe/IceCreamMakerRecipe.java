...
public class IceCreamMakerRecipe implements Recipe<SimpleInventory> {
    ...
    public IceCreamMakerRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<IceCreamMakerRecipe> {
        ...
        public static final String ID = "ice_cream_maker";
    }
    ...
    public static class Serializer implements RecipeSerializer<IceCreamMakerRecipe> {
        ...
        @Override
        public IceCreamMakerRecipe read(Identifier id, JsonObject json) {
            ...
            return new IceCreamMakerRecipe(id, output, inputs);
        }

        @Override
        public IceCreamMakerRecipe read(Identifier id, PacketByteBuf buf) {
