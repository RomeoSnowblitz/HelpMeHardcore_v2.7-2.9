...
import net.romeosnowblitz.hmh2.block.custom.test.NewBedBlockEntity;
...
public class ModBlockEntities {
    ...
    public static BlockEntityType<BedBlockEntity> ROSE_BED  =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Hmh2.MOD_ID, "rose"),
                    FabricBlockEntityTypeBuilder.create(BedBlockEntity::new, ModBlocks.ROSE_BED).build(null));
