...
public abstract class HeatedOilFluid extends FlowableFluid {
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.HEATED_OIL_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends HeatedOilFluid {
