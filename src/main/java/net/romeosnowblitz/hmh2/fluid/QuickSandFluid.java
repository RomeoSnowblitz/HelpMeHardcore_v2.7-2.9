...
public class QuickSandFluid extends FlowableFluid {
    ...
    public Item getBucketItem() {
        return ModItems.QUICKSAND_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.QUICKSAND_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.QUICKSAND_STILL || fluid == ModFluids.QUICKSAND_FLOWING;
    }
