...
public abstract class SlowFallingFluid extends FlowableFluid {
    public SlowFallingFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.SLOW_FALLING_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.SLOW_FALLING_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.SLOW_FALLING_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.SLOW_FALLING_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.SLOW_FALLING_FLUID_STILL || fluid == ModFluids.SLOW_FALLING_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends SlowFallingFluid {
        public Flowing() {
        }
    ...
    public static class Still extends SlowFallingFluid {
        public Still() {
        }
