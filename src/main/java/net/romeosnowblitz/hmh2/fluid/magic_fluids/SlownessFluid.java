...
public abstract class SlownessFluid extends FlowableFluid {
    public SlownessFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.SLOWNESS_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.SLOWNESS_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.SLOWNESS_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.SLOWNESS_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.SLOWNESS_FLUID_STILL || fluid == ModFluids.SLOWNESS_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends SlownessFluid {
        public Flowing() {
        }
    ...
    public static class Still extends SlownessFluid {
        public Still() {
        }
