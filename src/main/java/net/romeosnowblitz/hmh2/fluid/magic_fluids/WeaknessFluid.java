...
public abstract class WeaknessFluid extends FlowableFluid {
    public WeaknessFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.WEAKNESS_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.WEAKNESS_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.WEAKNESS_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.WEAKNESS_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.WEAKNESS_FLUID_STILL || fluid == ModFluids.WEAKNESS_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends WeaknessFluid {
        public Flowing() {
        }
    ...
    public static class Still extends WeaknessFluid {
        public Still() {
        }
