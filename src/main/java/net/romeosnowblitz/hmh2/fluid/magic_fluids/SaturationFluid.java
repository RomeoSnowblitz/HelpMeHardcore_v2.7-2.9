...
public abstract class SaturationFluid extends FlowableFluid {
    public SaturationFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.SATURATION_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.SATURATION_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.SATURATION_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.SATURATION_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.SATURATION_FLUID_STILL || fluid == ModFluids.SATURATION_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends SaturationFluid {
        public Flowing() {
        }
    ...
    public static class Still extends SaturationFluid {
        public Still() {
        }
