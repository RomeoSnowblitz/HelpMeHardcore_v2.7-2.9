...
public abstract class HungerFluid extends FlowableFluid {
    public HungerFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.HUNGER_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.HUNGER_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.HUNGER_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.HUNGER_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.HUNGER_FLUID_STILL || fluid == ModFluids.HUNGER_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends HungerFluid {
        public Flowing() {
        }
    ...
    public static class Still extends HungerFluid {
        public Still() {
        }
