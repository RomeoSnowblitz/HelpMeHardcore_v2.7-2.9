...
public abstract class HasteFluid extends FlowableFluid {
    public HasteFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.HASTE_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.HASTE_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.HASTE_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.HASTE_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.HASTE_FLUID_STILL || fluid == ModFluids.HASTE_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends HasteFluid {
        public Flowing() {
        }
    ...
    public static class Still extends HasteFluid {
        public Still() {
        }
