...
public abstract class ResistanceFluid extends FlowableFluid {
    public ResistanceFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.RESISTANCE_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.RESISTANCE_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.RESISTANCE_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.RESISTANCE_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.RESISTANCE_FLUID_STILL || fluid == ModFluids.RESISTANCE_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends ResistanceFluid {
        public Flowing() {
        }
    ...
    public static class Still extends ResistanceFluid {
        public Still() {
        }
