...
public abstract class WitherFluid extends FlowableFluid {
    public WitherFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.WITHER_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.WITHER_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.WITHER_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.WITHER_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.WITHER_FLUID_STILL || fluid == ModFluids.WITHER_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends WitherFluid {
        public Flowing() {
        }
    ...
    public static class Still extends WitherFluid {
        public Still() {
        }
