...
public abstract class InvisibilityFluid extends FlowableFluid {
    public InvisibilityFluid() {
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.INVISIBILITY_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends InvisibilityFluid {
        public Flowing() {
        }
    ...
    public static class Still extends InvisibilityFluid {
        public Still() {
        }
