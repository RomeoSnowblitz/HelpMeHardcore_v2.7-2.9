...
public abstract class BadLuckFluid extends FlowableFluid {
    public BadLuckFluid() {
    }
    ...
    public static class Flowing extends BadLuckFluid {
        public Flowing() {
        }
    ...
    public static class Still extends BadLuckFluid {
        public Still() {
        }
