...
public abstract class NightVisionFluid extends FlowableFluid {
    public NightVisionFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.NIGHT_VISION_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.NIGHT_VISION_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.NIGHT_VISION_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.NIGHT_VISION_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.NIGHT_VISION_FLUID_STILL || fluid == ModFluids.NIGHT_VISION_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends NightVisionFluid {
        public Flowing() {
        }
    ...
    public static class Still extends NightVisionFluid {
        public Still() {
        }
