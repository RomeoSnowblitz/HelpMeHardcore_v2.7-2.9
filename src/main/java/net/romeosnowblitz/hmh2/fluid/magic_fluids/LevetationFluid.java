...
public abstract class LevetationFluid extends FlowableFluid {
    public LevetationFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.LEVITATION_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.LEVITATION_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.LEVITATION_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.LEVITATION_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.LEVITATION_FLUID_STILL || fluid == ModFluids.LEVITATION_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends LevetationFluid {
        public Flowing() {
        }
    ...
    public static class Still extends LevetationFluid {
        public Still() {
        }
