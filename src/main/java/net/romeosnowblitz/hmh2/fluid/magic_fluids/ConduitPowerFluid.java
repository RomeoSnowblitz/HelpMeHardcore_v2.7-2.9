...
public abstract class ConduitPowerFluid extends FlowableFluid {
    public ConduitPowerFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.CONDUIT_POWER_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.CONDUIT_POWER_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.CONDUIT_POWER_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.CONDUIT_POWER_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.CONDUIT_POWER_FLUID_STILL || fluid == ModFluids.CONDUIT_POWER_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends ConduitPowerFluid {
        public Flowing() {
        }
    ...
    public static class Still extends ConduitPowerFluid {
        public Still() {
        }
