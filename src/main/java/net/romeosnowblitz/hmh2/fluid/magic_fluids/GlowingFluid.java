...
public abstract class GlowingFluid extends FlowableFluid {
    public GlowingFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.GLOWING_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.GLOWING_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.GLOWING_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.GLOWING_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.GLOWING_FLUID_STILL || fluid == ModFluids.GLOWING_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends GlowingFluid {
        public Flowing() {
        }
    ...
    public static class Still extends GlowingFluid {
        public Still() {
        }
