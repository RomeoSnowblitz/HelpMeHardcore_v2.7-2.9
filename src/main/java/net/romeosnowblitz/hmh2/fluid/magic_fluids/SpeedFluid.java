...
public abstract class SpeedFluid extends FlowableFluid {
    public SpeedFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.SPEED_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.SPEED_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.SPEED_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.SPEED_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.SPEED_FLUID_STILL || fluid == ModFluids.SPEED_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends SpeedFluid {
        public Flowing() {
        }
    ...
    public static class Still extends SpeedFluid {
        public Still() {
        }
