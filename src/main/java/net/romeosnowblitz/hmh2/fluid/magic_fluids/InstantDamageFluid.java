...
public abstract class InstantDamageFluid extends FlowableFluid {
    public InstantDamageFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.INSTANT_DAMAGE_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.INSTANT_DAMAGE_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.INSTANT_DAMAGE_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.INSTANT_DAMAGE_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.INSTANT_DAMAGE_FLUID_STILL || fluid == ModFluids.INSTANT_DAMAGE_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends InstantDamageFluid {
        public Flowing() {
        }
    ...
    public static class Still extends InstantDamageFluid {
        public Still() {
        }
