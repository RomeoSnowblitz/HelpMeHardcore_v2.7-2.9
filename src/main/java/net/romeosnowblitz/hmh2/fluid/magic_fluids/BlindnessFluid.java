...
public abstract class BlindnessFluid extends FlowableFluid {
    public BlindnessFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.BLINDNESS_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.BLINDNESS_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.BLINDNESS_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.BLINDNESS_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.BLINDNESS_FLUID_STILL || fluid == ModFluids.BLINDNESS_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends BlindnessFluid {
        public Flowing() {
        }
    ...
    public static class Still extends BlindnessFluid {
        public Still() {
        }
