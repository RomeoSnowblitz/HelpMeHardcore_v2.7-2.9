...
public abstract class MiningFatigueFluid extends FlowableFluid {
    public MiningFatigueFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.MINING_FATIGUE_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.MINING_FATIGUE_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.MINING_FATIGUE_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.MINING_FATIGUE_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.MINING_FATIGUE_FLUID_STILL || fluid == ModFluids.MINING_FATIGUE_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends MiningFatigueFluid {
        public Flowing() {
        }
    ...
    public static class Still extends MiningFatigueFluid {
        public Still() {
        }
