...
public abstract class BadOmenFluid extends FlowableFluid {
    public BadOmenFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.BAD_OMEN_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.BAD_OMEN_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.BAD_OMEN_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.BAD_OMEN_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.BAD_OMEN_FLUID_STILL || fluid == ModFluids.BAD_OMEN_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends BadOmenFluid {
        public Flowing() {
        }
    ...
    public static class Still extends BadOmenFluid {
        public Still() {
        }
