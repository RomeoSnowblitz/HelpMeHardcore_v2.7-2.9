...
public abstract class RegenerationFluid extends FlowableFluid {
    public RegenerationFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.REGENERATION_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.REGENERATION_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.REGENERATION_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.REGENERATION_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.REGENERATION_FLUID_STILL || fluid == ModFluids.REGENERATION_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends RegenerationFluid {
        public Flowing() {
        }
    ...
    public static class Still extends RegenerationFluid {
        public Still() {
        }
