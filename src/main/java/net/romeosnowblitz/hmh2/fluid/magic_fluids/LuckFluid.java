...
public abstract class LuckFluid extends FlowableFluid {
    public LuckFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.LUCK_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.LUCK_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.LUCK_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.LUCK_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.LUCK_FLUID_STILL || fluid == ModFluids.LUCK_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends LuckFluid {
        public Flowing() {
        }
    ...
    public static class Still extends LuckFluid {
        public Still() {
        }
