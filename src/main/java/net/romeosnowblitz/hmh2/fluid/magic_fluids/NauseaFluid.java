...
public abstract class NauseaFluid extends FlowableFluid {
    public NauseaFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.NAUSEA_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.NAUSEA_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.NAUSEA_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.NAUSEA_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.NAUSEA_FLUID_STILL || fluid == ModFluids.NAUSEA_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends NauseaFluid {
        public Flowing() {
        }
    ...
    public static class Still extends NauseaFluid {
        public Still() {
        }
