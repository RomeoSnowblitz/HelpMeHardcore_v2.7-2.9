...
public abstract class DarknessFluid extends FlowableFluid {
    public DarknessFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.DARKNESS_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.DARKNESS_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.DARKNESS_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.DARKNESS_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.DARKNESS_FLUID_STILL || fluid == ModFluids.DARKNESS_FLUID_FLOWING;
    }
    ...
    public static class Still extends DarknessFluid {
        public Still() {
        }
