...
public abstract class FireImmunityFluid extends FlowableFluid {
    public FireImmunityFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.FIRE_IMMUNITY_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.FIRE_IMMUNITY_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.FIRE_IMMUNITY_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.FIRE_IMMUNITY_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.FIRE_IMMUNITY_FLUID_STILL || fluid == ModFluids.FIRE_IMMUNITY_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends FireImmunityFluid {
        public Flowing() {
        }
    ...
    public static class Still extends FireImmunityFluid {
        public Still() {
        }
