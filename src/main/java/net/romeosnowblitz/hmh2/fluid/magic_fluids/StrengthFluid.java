...
public abstract class StrengthFluid extends FlowableFluid {
    public StrengthFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.STRENGTH_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.STRENGTH_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.STRENGTH_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.STRENGTH_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.STRENGTH_FLUID_STILL || fluid == ModFluids.STRENGTH_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends StrengthFluid {
        public Flowing() {
        }
    ...
    public static class Still extends StrengthFluid {
        public Still() {
        }
