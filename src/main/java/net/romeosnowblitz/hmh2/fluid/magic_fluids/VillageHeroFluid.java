...
public abstract class VillageHeroFluid extends FlowableFluid {
    public VillageHeroFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.VILLAGE_HERO_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.VILLAGE_HERO_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.VILLAGE_HERO_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.VILLAGE_HERO_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.VILLAGE_HERO_FLUID_STILL || fluid == ModFluids.VILLAGE_HERO_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends VillageHeroFluid {
        public Flowing() {
        }
    ...
    public static class Still extends VillageHeroFluid {
        public Still() {
        }
