...
public abstract class JumpBoostFluid extends FlowableFluid {
    public JumpBoostFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.JUMP_BOOST_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.JUMP_BOOST_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.JUMP_BOOST_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.JUMP_BOOST_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.JUMP_BOOST_FLUID_STILL || fluid == ModFluids.JUMP_BOOST_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends JumpBoostFluid {
        public Flowing() {
        }
    ...
    public static class Still extends JumpBoostFluid {
        public Still() {
        }
