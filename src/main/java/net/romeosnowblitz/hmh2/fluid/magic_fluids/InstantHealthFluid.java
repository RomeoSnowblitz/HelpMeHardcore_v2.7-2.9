...
public abstract class InstantHealthFluid extends FlowableFluid {
    public InstantHealthFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.INSTANT_HEALTH_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.INSTANT_HEALTH_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.INSTANT_HEALTH_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.INSTANT_HEALTH_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.INSTANT_HEALTH_FLUID_STILL || fluid == ModFluids.INSTANT_HEALTH_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends InstantHealthFluid {
        public Flowing() {
        }
    ...
    public static class Still extends InstantHealthFluid {
        public Still() {
        }
