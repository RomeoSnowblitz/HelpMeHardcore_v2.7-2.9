...
public abstract class HealthBoostFluid extends FlowableFluid {
    public HealthBoostFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.HEALTH_BOOST_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.HEALTH_BOOST_FLUID_STILL;
    }

    public Item getBucketItem() {
        return MagicItems.HEALTH_BOOST_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MagicBlocks.HEALTH_BOOST_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.HEALTH_BOOST_FLUID_STILL || fluid == ModFluids.HEALTH_BOOST_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends HealthBoostFluid {
        public Flowing() {
        }
    ...
    public static class Still extends HealthBoostFluid {
        public Still() {
        }
