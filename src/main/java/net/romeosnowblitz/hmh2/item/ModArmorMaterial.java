...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    }), 30, SoundEvents.BLOCK_HONEY_BLOCK_SLIDE, 1.0F, 0.1F, () -> Ingredient.ofItems(Items.HONEYCOMB)),
    ...
    SUMOLTERITE("sumolterite", 37, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 3);map.put(ArmorItem.Type.LEGGINGS, 6);map.put(ArmorItem.Type.CHESTPLATE, 8);map.put(ArmorItem.Type.HELMET, 3);
