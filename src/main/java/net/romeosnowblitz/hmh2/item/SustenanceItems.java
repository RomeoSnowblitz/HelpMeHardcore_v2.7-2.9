...
public class SustenanceItems {
    public static final Item APPLE_JUICE = registerItem("apple_juice", new HoneyBottleItem(new Item.Settings().recipeRemainder(Items.GLASS_BOTTLE).food(FoodComponents.HONEY_BOTTLE).maxCount(16)));
    public static final Item APPLE_PIE = registerItem("apple_pie", new ConsumeLeaveItem(40, SoundEvents.ENTITY_GENERIC_EAT, ModItems.SHEET_PAN.getDefaultStack(), new FabricItemSettings().recipeRemainder(Items.BUCKET).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.3f).build())));
    ...
    public static final Item BANANAS = registerItem("bananas", new ConsumeLeaveItem(40, SoundEvents.ENTITY_GENERIC_EAT, ModBlocks.BANANA_PEEL.asItem().getDefaultStack(), new FabricItemSettings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.3f).alwaysEdible().build())));
    ...
    public static final Item BLUEBERRY_JAM = registerItem("blueberry_jam", new ConsumeLeaveItem(40, SoundEvents.ITEM_HONEY_BOTTLE_DRINK, Items.GLASS_BOTTLE.getDefaultStack(),  new FabricItemSettings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build())));
    public static final Item BLUEBERRY_PIE = registerItem("blueberry_pie", new ConsumeLeaveItem(40, SoundEvents.ENTITY_GENERIC_EAT, ModItems.SHEET_PAN.getDefaultStack(), new FabricItemSettings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.3f).build())));
    ...
    public static final Item CHERRY_PIE = registerItem("cherry_pie", new ConsumeLeaveItem(40, SoundEvents.ENTITY_GENERIC_EAT, ModItems.SHEET_PAN.getDefaultStack(), new FabricItemSettings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.3f).build())));
    ...
    public static final Item LURE = registerItem("lure", new ClasslessCrafting(Items.FISHING_ROD, ModItems.LURED_ROD, new FabricItemSettings().food(new FoodComponent.Builder().hunger(1).saturationModifier(0.2f).build())));
    ...
    public static final Item ORANGE_JUICE = registerItem("orange_juice", new HoneyBottleItem(new Item.Settings().recipeRemainder(Items.GLASS_BOTTLE).food(FoodComponents.HONEY_BOTTLE).maxCount(16)));
    public static final Item PIRANHA_FISH = registerItem("piranha_fish", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(3).saturationModifier(0.3f).statusEffect(new StatusEffectInstance(CustomEffects.INSUSCEPTIBILITY, 600, 0), 1).meat().build())));
    ...
    public static final Item STRAWBERRY_JAM = registerItem("strawberry_jam", new ConsumeLeaveItem(40, SoundEvents.ITEM_HONEY_BOTTLE_DRINK, Items.GLASS_BOTTLE.getDefaultStack(), new FabricItemSettings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build())));
    public static final Item STRAWBERRY_PIE = registerItem("strawberry_pie", new ConsumeLeaveItem(40, SoundEvents.ENTITY_GENERIC_EAT, ModItems.SHEET_PAN.getDefaultStack(), new FabricItemSettings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.3f).build())));
