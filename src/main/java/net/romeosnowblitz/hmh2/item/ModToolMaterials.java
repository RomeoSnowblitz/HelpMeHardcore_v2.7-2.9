...
public enum ModToolMaterials implements ToolMaterial {
    ...
    BLAZE(4, 420, 12.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.BLAZE_ROD)),
    ...
    CLUB(2, 200, 6.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.OAK_LOG)),
    ENDER_DUST(6, 3000, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.ENDER_DUST)),
    ENDER_INGOT(6, 3000, 12.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.ENDER_INGOT)),
    HELLSTONE(4, 2250, 8.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.HELLSTONE)),
    MOD_GOLD(3, 250, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    MOD_IRON(3, 750, 6.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.IRON_INGOT)),
    ...
    QUAERITE(6, 9000, 9.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.QUAERITE_FRAGMENT)),
    STICK(3, 906, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.STICK)),
    SILK(3, 906, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.SILK)),
    SUMOLTERITE(5, 4500, 12.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.SOLAR_FRAGMENT)),
