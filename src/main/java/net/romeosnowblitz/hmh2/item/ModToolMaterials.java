...
public enum ModToolMaterials implements ToolMaterial {
    ...
    ENDER_INGOT(6, 3000, 9.0F, 4.0F, 30, () -> Ingredient.ofItems(ModItems.ENDER_INGOT)),
    ...
    QUAERITE(6, 9000, 12.0F, 4.0F, 30, () -> Ingredient.ofItems(ModItems.QUAERITE_FRAGMENT)),
    STICK(3, 906, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(Items.STICK)),
    SILK(3, 906, 1.0F, -1.0F, 30, () -> Ingredient.ofItems(ModItems.SILK)),
    SUMOLTERITE(5, 4500, 12.0F, 4.0F, 30, () -> Ingredient.ofItems(ModItems.SOLAR_FRAGMENT)),
