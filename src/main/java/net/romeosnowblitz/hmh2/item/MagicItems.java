...
import net.romeosnowblitz.hmh2.crafting.MinecraftAmulets;
...
public class MagicItems {
    ...
    public static final Item AMULET = registerItem("amulet", new MinecraftAmulets(new FabricItemSettings()));
    public static final Item SPEED_AMULET = registerItem("amulet_of_acceleration", new MagicGoodAmulet(StatusEffects.SPEED, 200, new FabricItemSettings()));
    public static final Item LEVITATION_AMULET = registerItem("amulet_of_antigravity", new MagicGoodAmulet(StatusEffects.LEVITATION, 200, new FabricItemSettings().maxDamage(100)));
    public static final Item MINING_FATIGUE_AMULET = registerItem("amulet_of_arthritis", new MagicBadAmulet(StatusEffects.MINING_FATIGUE, 200, new FabricItemSettings().maxDamage(100)));
    public static final Item UNLUCK_AMULET = registerItem("amulet_of_bad_luck", new MagicBadAmulet(StatusEffects.UNLUCK, 200, new FabricItemSettings().maxDamage(64)));
    public static final Item INSTANT_DAMAGE_AMULET = registerItem("amulet_of_bricks", new MagicBadAmulet(CustomEffects.SPIDER_EFFECT, 200, new FabricItemSettings().maxDamage(10)));
    public static final Item NAUSEA_AMULET = registerItem("amulet_of_bro_you_gotta_try_this", new MagicBadAmulet(StatusEffects.NAUSEA, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item WATER_BREATHING_AMULET = registerItem("amulet_of_bubbles", new MagicGoodAmulet(StatusEffects.WATER_BREATHING, 200, new FabricItemSettings()));
    public static final Item INVISIBILITY_AMULET = registerItem("amulet_of_cloaking", new MagicGoodAmulet(StatusEffects.INVISIBILITY, 200, new FabricItemSettings().maxDamage(100)));
    public static final Item BLINDNESS_AMULET = registerItem("amulet_of_closed_eyes", new MagicBadAmulet(StatusEffects.BLINDNESS, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item LUCK_AMULET = registerItem("amulet_of_clovers", new MagicGoodAmulet(StatusEffects.LUCK, 200, new FabricItemSettings().maxDamage(64)));
    public static final Item WITHER_AMULET = registerItem("amulet_of_decay", new MagicBadAmulet(StatusEffects.WITHER, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item ABSORPTION_AMULET = registerItem("amulet_of_endurance", new MagicGoodAmulet(StatusEffects.ABSORPTION, 200, new FabricItemSettings().maxDamage(100)));
    public static final Item HASTE_AMULET = registerItem("amulet_of_excavation", new MagicGoodAmulet(StatusEffects.HASTE, 200, new FabricItemSettings()));
    public static final Item HEALTH_BOOST_AMULET = registerItem("amulet_of_extra_love", new MagicGoodAmulet(StatusEffects.HEALTH_BOOST, 200, new FabricItemSettings().maxDamage(100)));
    public static final Item FIRE_IMMUNITY_AMULET = registerItem("amulet_of_flamelessness", new MagicGoodAmulet(StatusEffects.FIRE_RESISTANCE, 200, new FabricItemSettings().maxDamage(128)));
    public static final Item WEAKNESS_AMULET = registerItem("amulet_of_frailty", new MagicBadAmulet(StatusEffects.WEAKNESS, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item CONDUIT_POWER_AMULET = registerItem("amulet_of_gills", new MagicGoodAmulet(StatusEffects.CONDUIT_POWER, 200, new FabricItemSettings()));
    public static final Item HUNGER_AMULET = registerItem("amulet_of_gluttony", new MagicBadAmulet(StatusEffects.HUNGER, 200, new FabricItemSettings().maxDamage(64)));
    public static final Item REGENERATION_AMULET = registerItem("amulet_of_healing", new MagicGoodAmulet(StatusEffects.REGENERATION, 200, new FabricItemSettings().maxDamage(32)));
    public static final Item STRENGTH_AMULET = registerItem("amulet_of_hercules", new MagicGoodAmulet(StatusEffects.STRENGTH, 200, new FabricItemSettings().maxDamage(10)));
    public static final Item GLOWING_AMULET = registerItem("amulet_of_illumination", new MagicGoodAmulet(StatusEffects.GLOWING, 200, new FabricItemSettings()));
    public static final Item JUMP_BOOST_AMULET = registerItem("amulet_of_leaping", new MagicGoodAmulet(StatusEffects.JUMP_BOOST, 200, new FabricItemSettings().maxDamage(128)));
    public static final Item NIGHT_VISION_AMULET = registerItem("amulet_of_night_sight", new MagicGoodAmulet(StatusEffects.NIGHT_VISION, 200, new FabricItemSettings()));
    public static final Item SATURATION_AMULET = registerItem("amulet_of_nourishment", new MagicGoodAmulet(StatusEffects.SATURATION, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item DOLPHINS_GRACE_AMULET = registerItem("amulet_of_olympic_swimming", new MagicGoodAmulet(StatusEffects.DOLPHINS_GRACE, 200, new FabricItemSettings()));
    public static final Item BAD_OMEN_AMULET = registerItem("amulet_of_raids", new MagicBadAmulet(StatusEffects.BAD_OMEN, 200, new FabricItemSettings().maxDamage(32)));
    public static final Item INSTANT_HEALTH_AMULET = registerItem("amulet_of_rejuvination", new MagicGoodAmulet(CustomEffects.BLOOD_FEVER, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item DARKNESS_AMULET = registerItem("amulet_of_shadows", new MagicBadAmulet(StatusEffects.DARKNESS, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item RESISTANCE_AMULET = registerItem("amulet_of_shielding", new MagicGoodAmulet(StatusEffects.RESISTANCE, 200, new FabricItemSettings().maxDamage(32)));
    public static final Item POISON_AMULET = registerItem("amulet_of_sickening", new MagicBadAmulet(StatusEffects.POISON, 200, new FabricItemSettings().maxDamage(16)));
    public static final Item SLOW_FALLING_AMULET = registerItem("amulet_of_the_phantom", new MagicGoodAmulet(StatusEffects.SLOW_FALLING, 200, new FabricItemSettings()));
    public static final Item SLOWNESS_AMULET = registerItem("amulet_of_the_tortise", new MagicBadAmulet(StatusEffects.SLOWNESS, 200, new FabricItemSettings().maxDamage(64)));
    public static final Item VILLAGE_HERO_AMULET = registerItem("amulet_of_the_village_hero", new MagicGoodAmulet(StatusEffects.HERO_OF_THE_VILLAGE, 200, new FabricItemSettings().maxDamage(100)));
    ...
    public static final Item INSTANT_DAMAGE_FLUID = registerItem("instant_damage_fluid", new MagicBucket(CustomEffects.SPIDER_EFFECT, ModFluids.INSTANT_DAMAGE_FLUID_STILL, new FabricItemSettings().recipeRemainder(BUCKET).maxCount(1)));
    public static final Item INSTANT_HEALTH_FLUID = registerItem("instant_health_fluid", new MagicBucket(CustomEffects.BLOOD_FEVER, ModFluids.INSTANT_HEALTH_FLUID_STILL, new FabricItemSettings().recipeRemainder(BUCKET).maxCount(1)));
