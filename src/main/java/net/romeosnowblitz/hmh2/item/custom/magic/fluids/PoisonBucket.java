...
public class PoisonBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public PoisonBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 200, 4));
        }
