...
public class DolphinsGraceBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public DolphinsGraceBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 200, 4));
        }
