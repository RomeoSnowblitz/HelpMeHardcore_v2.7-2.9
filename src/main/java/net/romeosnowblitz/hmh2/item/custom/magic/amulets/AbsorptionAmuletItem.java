...
public class AbsorptionAmuletItem extends Item {
    ...
    public AbsorptionAmuletItem(Settings settings) {
        super(settings);
    }
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        attacker.addStatusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 200, 1), attacker);
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 200, 0), target);
