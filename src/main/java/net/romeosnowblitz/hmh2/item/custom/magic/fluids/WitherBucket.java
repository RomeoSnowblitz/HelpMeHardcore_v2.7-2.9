...
public class WitherBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public WitherBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.WITHER, 200, 4));
        }
