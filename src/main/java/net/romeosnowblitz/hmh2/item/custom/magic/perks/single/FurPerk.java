...
extends class_1738 {
    public FurPerk(class_1741 material, class_1738.class_8051 type, class_1792.class_1793 settings) {
    ...
    public void method_7888(class_1799 stack, class_1937 world, class_1297 entity, int slot, boolean selected) {
        if (!world.method_8608() && entity instanceof class_1657) {
            ...
            if (headPiece.method_31574(WarfareItems.FUR_HELMET) || chestPiece.method_31574(WarfareItems.FUR_CHESTPLATE) || legPiece.method_31574(WarfareItems.FUR_LEGGINGS) || footPiece.method_31574(WarfareItems.FUR_BOOTS)) {
                player.method_6092(new class_1293(CustomEffects.LUNAR_WOLF_PERCEPTION, 60, 0, false, false, true));
            }
        }
