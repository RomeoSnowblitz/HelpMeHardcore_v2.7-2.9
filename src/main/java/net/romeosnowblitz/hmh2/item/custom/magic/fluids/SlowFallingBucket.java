...
public class SlowFallingBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public SlowFallingBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 200, 4));
        }
