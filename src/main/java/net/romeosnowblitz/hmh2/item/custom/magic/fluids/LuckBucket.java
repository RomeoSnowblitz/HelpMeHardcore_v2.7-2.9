...
public class LuckBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public LuckBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.LUCK, 200, 4));
        }
