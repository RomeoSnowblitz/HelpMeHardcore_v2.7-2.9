...
public class ConduitPowerBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public ConduitPowerBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.CONDUIT_POWER, 200, 4));
        }
