...
public class FullEmeraldPerk extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(ModArmorMaterial.EMERALD, StatusEffects.HERO_OF_THE_VILLAGE).build();

    public FullEmeraldPerk(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
