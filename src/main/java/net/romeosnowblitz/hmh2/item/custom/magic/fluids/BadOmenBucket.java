...
public class BadOmenBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public BadOmenBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.BAD_OMEN, 200, 4));
        }
