...
public class WaterBreathingBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public WaterBreathingBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 200, 4));
        }
