...
public class FullHellstonePerk extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(ModArmorMaterial.HELLSTONE, StatusEffects.FIRE_RESISTANCE).build();

    public FullHellstonePerk(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
