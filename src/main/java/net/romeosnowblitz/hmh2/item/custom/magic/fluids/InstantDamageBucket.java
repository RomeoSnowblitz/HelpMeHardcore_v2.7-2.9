...
public class InstantDamageBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public InstantDamageBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 200, 4));
        }
