    ...
    public static void registerItemGroup() {
        ...
        Registry.register(Registries.ITEM_GROUP, MOD, FabricItemGroup.builder().displayName(Text.translatable("Mod"))
                .icon(() -> new ItemStack(ModBlocks.BLOCK)).entries((context, entries) -> {
                    entries.add(ModBlocks.MOD_COMPOSTER);
        ...
        Registry.register(Registries.ITEM_GROUP, MAGIC, FabricItemGroup.builder().displayName(Text.translatable("Magic"))
                .icon(() -> new ItemStack(MagicItems.KNIGHT_CHARM)).entries((context, entries) -> {
                    ...
                    entries.add(MagicItems.AMBER_LOCKET);
                    entries.add(MagicItems.ANDALUSITE_LOCKET);
                    entries.add(MagicItems.AQUAMARINE_LOCKET);
                    entries.add(MagicItems.CHARCOAL_LOCKET);
                    entries.add(MagicItems.CITRINE_LOCKET);
                    entries.add(MagicItems.DIOPSIDE_LOCKET);
                    entries.add(MagicItems.GARNET_LOCKET);
                    entries.add(MagicItems.HESSONITE_LOCKET);
                    entries.add(MagicItems.MALICHITE_LOCKET);
                    entries.add(MagicItems.MOONSTONE_LOCKET);
                    entries.add(MagicItems.OPAL_LOCKET);
                    entries.add(MagicItems.PERIDOT_LOCKET);
                    entries.add(MagicItems.PREHNITE_LOCKET);
                    entries.add(MagicItems.RUBY_LOCKET);
                    entries.add(MagicItems.SAPPHIRE_LOCKET);
                    entries.add(MagicItems.SMOKY_QUARTZ_LOCKET);
                    entries.add(MagicItems.SPESSARITE_LOCKET);
                    entries.add(MagicItems.SPHENE_LOCKET);
                    entries.add(MagicItems.SPINEL_LOCKET);
                    entries.add(MagicItems.TANZANITE_LOCKET);
                    entries.add(MagicItems.TOPAZ_LOCKET);
                    entries.add(MagicItems.TORMALINE_LOCKET);
                    entries.add(MagicItems.TSAVORITE_LOCKET);
                    entries.add(MagicItems.ZIRCON_LOCKET);
                    entries.add(MagicItems.AMULET_OF_ACCELERATION);
                    entries.add(MagicItems.AMULET_OF_ANTIGRAVITY);
                    entries.add(MagicItems.AMULET_OF_ARTHRITIS);
                    entries.add(MagicItems.AMULET_OF_BAD_LUCK);
                    entries.add(MagicItems.AMULET_OF_BRICKS);
                    entries.add(MagicItems.AMULET_OF_BRO_YOU_GOTTA_TRY_THIS);
                    entries.add(MagicItems.AMULET_OF_BUBBLES);
                    entries.add(MagicItems.AMULET_OF_CLOAKING);
                    entries.add(MagicItems.AMULET_OF_CLOSED_EYES);
                    entries.add(MagicItems.AMULET_OF_CLOVERS);
                    entries.add(MagicItems.AMULET_OF_DECAY);
                    entries.add(MagicItems.AMULET_OF_ENDURANCE);
                    entries.add(MagicItems.AMULET_OF_EXCAVATION);
                    entries.add(MagicItems.AMULET_OF_EXTRA_LOVE);
                    entries.add(MagicItems.AMULET_OF_FLAMELESSNESS);
                    entries.add(MagicItems.AMULET_OF_FRAILTY);
                    entries.add(MagicItems.AMULET_OF_GILLS);
                    entries.add(MagicItems.AMULET_OF_GLUTTONY);
                    entries.add(MagicItems.AMULET_OF_HEALING);
                    entries.add(MagicItems.AMULET_OF_HERCULES);
                    entries.add(MagicItems.AMULET_OF_ILLUMINATION);
                    entries.add(MagicItems.AMULET_OF_LEAPING);
                    entries.add(MagicItems.AMULET_OF_NIGHT_SIGHT);
                    entries.add(MagicItems.AMULET_OF_NOURISHMENT);
                    entries.add(MagicItems.AMULET_OF_OLYMPIC_SWIMMING);
                    entries.add(MagicItems.AMULET_OF_RAIDS);
                    entries.add(MagicItems.AMULET_OF_REJUVINATION);
                    entries.add(MagicItems.AMULET_OF_SHADOWS);
                    entries.add(MagicItems.AMULET_OF_SHIELDING);
                    entries.add(MagicItems.AMULET_OF_SICKENING);
                    entries.add(MagicItems.AMULET_OF_THE_PHANTOM);
                    entries.add(MagicItems.AMULET_OF_THE_TORTISE);
                    entries.add(MagicItems.AMULET_OF_THE_VILLAGE_HERO);
        ...
        Registry.register(Registries.ITEM_GROUP, TESTING, FabricItemGroup.builder().displayName(Text.translatable("Testing"))
