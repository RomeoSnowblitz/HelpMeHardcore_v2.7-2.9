...
public class SculkmiteEntity
    ...
    public boolean tryAttack(Entity target) {
        ...
        StatusEffectInstance statusEffectInstance = livingEntity.getStatusEffect(CustomEffects.SIGHTLESSSNESS);
        if (target instanceof LivingEntity) {
            int i = 1;
            if (statusEffectInstance != null) {
                i += statusEffectInstance.getAmplifier();
                livingEntity.removeStatusEffectInternal(CustomEffects.SIGHTLESSSNESS);
            } else {
                --i;
            }
