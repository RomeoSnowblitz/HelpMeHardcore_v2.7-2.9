...
public class SpearEntity extends PersistentProjectileEntity {
    ...
    public SpearEntity(World world, LivingEntity owner, ItemStack stack) {
        ...
        this.spearStack = new ItemStack(Items.TRIDENT);
        this.spearStack = stack.copy();
        this.dataTracker.set(LOYALTY, (byte)EnchantmentHelper.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public SpearEntity(EntityType<SpearEntity> entityEntityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>) entityEntityType, world);
        this.spearStack = new ItemStack(Items.TRIDENT);
    }
