...
public class QueenBeeEntity extends SpellcastingIllagerEntity implements GeoEntity {
    ...
    public boolean tryAttack(Entity target) {
        ...
        if (target instanceof LivingEntity) {
            ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 200, 9), this);
        }
        return true;
    }
