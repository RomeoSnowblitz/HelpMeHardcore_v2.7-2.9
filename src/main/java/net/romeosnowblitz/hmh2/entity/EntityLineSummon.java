...
public class EntityLineSummon extends Entity {
    ...
    public EntityLineSummon(EntityType<? extends SoldierBeeEntity> entityType, World world) {
        super(entityType, world);
    }

    public EntityLineSummon(World world, double x, double y, double z, float yaw, int warmup, LivingEntity owner) {
        this((EntityType<? extends SoldierBeeEntity>) MobEntities.SOLDIER_BEE, world);
        this.warmup = warmup;
        this.setOwner(owner);
