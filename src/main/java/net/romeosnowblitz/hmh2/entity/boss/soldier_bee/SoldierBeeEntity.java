...
public class SoldierBeeEntity extends HostileEntity {
    ...
    public boolean tryAttack(Entity target) {
        getTarget().addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 60, 0), this);
        return target.damage(getDamageSources().create(ModDamageTypes.KILLED_BY_SOLDIER_BEE, this), (float) this.getAttributeBaseValue(EntityAttributes.GENERIC_ATTACK_DAMAGE));
    }
