...
public class WarpmiteAnimations {
    public static final Animation WARPMITE_IDLE = Animation.Builder.create(1f).looping()
    ...
    public static final Animation WARPMITE_WALK = Animation.Builder.create(1f).looping()
            .addBoneAnimation("body1",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
