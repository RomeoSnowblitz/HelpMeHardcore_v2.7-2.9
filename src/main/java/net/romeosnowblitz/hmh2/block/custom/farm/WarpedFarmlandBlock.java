...
public class WarpedFarmlandBlock extends Block {

    public static final IntProperty MOISTURE = Properties.MOISTURE;
    protected static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 15.0, 16.0);
    public static final int MAX_MOISTURE = 7;

    public WarpedFarmlandBlock(Settings settings) {
        super(settings);
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (WarpedFarmlandBlock.isLavaNearby(world, pos) || world.hasRain(pos.up())) {
            if (i < 7) {
        ...
        } else if (!WarpedFarmlandBlock.hasModCrop(world, pos)) {
            WarpedFarmlandBlock.setToNylium(state, world, pos);
        }
    }
    ...
    public static void setToNylium(BlockState state, World world, BlockPos pos) {
        world.setBlockState(pos, WarpedFarmlandBlock.pushEntitiesUpBeforeBlockChange(state, Blocks.WARPED_NYLIUM.getDefaultState(), world, pos));
    }
