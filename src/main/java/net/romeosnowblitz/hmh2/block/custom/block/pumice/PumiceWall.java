...
public class PumiceWall extends Block implements Waterloggable {
    ...
    public PumiceWall(Settings settings) {
        super(settings);
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbWater(world, pos)) {
            world.setBlockState(pos, DecorationBlocks.HOT_PUMICE_WALL.getDefaultState(), 2);
