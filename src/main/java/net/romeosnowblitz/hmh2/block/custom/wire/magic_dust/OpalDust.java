...
public class OpalDust extends MultifaceGrowthBlock implements Waterloggable {

    public OpalDust(Block.Settings settings) {
        super(settings);
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        if (entity instanceof LivingEntity && !(livingEntity = (LivingEntity)entity).isInvulnerableTo(DamageSource.WITHER)) {
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.CONDUIT_POWER, 60));
        }
    }
