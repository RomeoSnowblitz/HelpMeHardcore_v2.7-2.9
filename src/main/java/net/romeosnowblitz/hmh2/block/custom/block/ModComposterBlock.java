...
public class ModComposterBlock extends Block implements InventoryProvider {
    ...
    public static void registerDefaultCompostableItems() {
        ...
        registerCompostableItem(0.3F, SustenanceItems.CHEESE_SLICE);
        ...
        registerCompostableItem(0.65F, SustenanceItems.BANANAS);
        registerCompostableItem(0.65F, SustenanceItems.BLUEBERRIES);
        registerCompostableItem(0.65F, SustenanceItems.CHEESE);
        registerCompostableItem(0.65F, SustenanceItems.CHERRIES);
        registerCompostableItem(0.65F, ModItems.CONE);
        registerCompostableItem(0.65F, SustenanceItems.TOAST);
        registerCompostableItem(0.65F, SustenanceItems.MANGO);
        registerCompostableItem(0.65F, SustenanceItems.ORANGE);
        registerCompostableItem(0.65F, SustenanceItems.STRAWBERRIES);
        registerCompostableItem(0.65F, ColoringBlocks.BLUE_SPIDER_LILY);
        registerCompostableItem(0.65F, ColoringBlocks.ROSE);
        registerCompostableItem(0.65F, ColoringBlocks.WOLFSBANE);
        ...
        registerCompostableItem(0.85F, SustenanceItems.CHOCOLATE_ICE_CREAM);
        registerCompostableItem(0.85F, SustenanceItems.BLUEBERRY_JAM);
        registerCompostableItem(0.85F, SustenanceItems.STRAWBERRY_JAM);
        registerCompostableItem(0.85F, SustenanceItems.BUTTERED_TOAST);
        ...
        registerCompostableItem(1.0F, DecorationBlocks.CORK_BLOCK);
