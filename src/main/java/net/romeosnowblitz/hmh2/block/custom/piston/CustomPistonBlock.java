...
public class CustomPistonBlock extends FacingBlock {
    ...
    public CustomPistonBlock(boolean sticky, AbstractBlock.Settings settings) {
        super(settings);
    ...
    public boolean onSyncedBlockEvent(BlockState state, World world, BlockPos pos, int type, int data) {
        ...
        if (type == 0) {
            ...
            if (this.sticky) {
                ...
                if (!bl2) {
                    if (type == 1 && !blockState2.isAir() && CustomPistonBlock.isMovable(blockState2, world, blockPos, direction.getOpposite(), false, direction) && (blockState2.getPistonBehavior() == PistonBehavior.NORMAL || blockState2.isOf(Blocks.PISTON) || blockState2.isOf(Blocks.STICKY_PISTON) || blockState2.isOf(ModBlocks.GLUEY_PISTON))) {
    ...
    private boolean move(World world, BlockPos pos, Direction dir, boolean retract) {
        ...
        for (k = list3.size() - 1; k >= 0; --k) {
            ...
            CustomPistonBlock.dropStacks(blockState, world, blockPos3, blockEntity);
