...
public class GarnetDust extends MultifaceGrowthBlock {

    public GarnetDust(Settings settings) {
        super(settings);
    }
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        if (entity instanceof LivingEntity && !(livingEntity = (LivingEntity)entity).isInvulnerableTo(world.getDamageSources().wither())) {
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 20));
        }
    }
