...
public class GoodEffectBlock extends Block {

    private final StatusEffect effect;
    public GoodEffectBlock(StatusEffect effect, Settings settings) {
        super(settings);
        this.effect = effect;
    }
    ...
    public void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        ...
        for (LivingEntity livingEntity : list) {
            if(livingEntity.hasStatusEffect(CustomEffects.SORCERER)){
                livingEntity.addStatusEffect(new StatusEffectInstance(effect, (int) (16-livingEntity.distanceTo(projectile))*20 , 1));
            } else {
                livingEntity.addStatusEffect(new StatusEffectInstance(effect, (int) (16-livingEntity.distanceTo(projectile))*20, 0));
            }
        }
