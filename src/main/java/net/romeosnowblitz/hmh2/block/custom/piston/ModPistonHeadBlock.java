...
public class ModPistonHeadBlock extends FacingBlock {
    public static final EnumProperty<ModPistonType> TYPE = ModProperties.PISTON_TYPE;
    ...
    private boolean isAttached(BlockState headState, BlockState pistonState) {
        Block block = headState.get(TYPE) == ModPistonType.DEFAULT ? Blocks.PISTON : ModBlocks.GLUEY_PISTON;
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(state.get(TYPE) == ModPistonType.GLUEY ? ModBlocks.GLUEY_PISTON : Blocks.PISTON);
    }
