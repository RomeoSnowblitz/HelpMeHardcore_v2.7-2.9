...
import net.romeosnowblitz.hmh2.block.custom.magic.MagicFluid;
...
public class MagicBlocks {
    ...
    public static final Block ABSORPTION_FLUID_BLOCK = registerBlockWithoutBlockItem("absorption_fluid_block", new MagicFluid(StatusEffects.ABSORPTION, ModFluids.ABSORPTION_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block BAD_LUCK_FLUID_BLOCK = registerBlockWithoutBlockItem("bad_luck_fluid_block", new MagicFluid(StatusEffects.UNLUCK, ModFluids.BAD_LUCK_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block BAD_OMEN_FLUID_BLOCK = registerBlockWithoutBlockItem("bad_omen_fluid_block", new MagicFluid(StatusEffects.BAD_OMEN, ModFluids.BAD_OMEN_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block BLINDNESS_FLUID_BLOCK = registerBlockWithoutBlockItem("blindness_fluid_block", new MagicFluid(StatusEffects.BLINDNESS, ModFluids.BLINDNESS_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block CONDUIT_POWER_FLUID_BLOCK = registerBlockWithoutBlockItem("conduit_power_fluid_block", new MagicFluid(StatusEffects.CONDUIT_POWER, ModFluids.CONDUIT_POWER_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block DARKNESS_FLUID_BLOCK = registerBlockWithoutBlockItem("darkness_fluid_block", new MagicFluid(StatusEffects.DARKNESS, ModFluids.DARKNESS_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block DOLPHINS_GRACE_FLUID_BLOCK = registerBlockWithoutBlockItem("dolphins_grace_fluid_block", new MagicFluid(StatusEffects.DOLPHINS_GRACE, ModFluids.DOLPHINS_GRACE_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block FIRE_IMMUNITY_FLUID_BLOCK = registerBlockWithoutBlockItem("fire_immunity_fluid_block", new MagicFluid(StatusEffects.FIRE_RESISTANCE, ModFluids.FIRE_IMMUNITY_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block GLOWING_FLUID_BLOCK = registerBlockWithoutBlockItem("glowing_fluid_block", new MagicFluid(StatusEffects.GLOWING, ModFluids.GLOWING_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block HASTE_FLUID_BLOCK = registerBlockWithoutBlockItem("haste_fluid_block", new MagicFluid(StatusEffects.HASTE, ModFluids.HASTE_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block HEALTH_BOOST_FLUID_BLOCK = registerBlockWithoutBlockItem("health_boost_fluid_block", new MagicFluid(StatusEffects.HEALTH_BOOST, ModFluids.HEALTH_BOOST_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block HUNGER_FLUID_BLOCK = registerBlockWithoutBlockItem("hunger_fluid_block", new MagicFluid(StatusEffects.HUNGER, ModFluids.HUNGER_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block INSTANT_DAMAGE_FLUID_BLOCK = registerBlockWithoutBlockItem("instant_damage_fluid_block", new MagicFluid(StatusEffects.INSTANT_DAMAGE, ModFluids.INSTANT_DAMAGE_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block INSTANT_HEALTH_FLUID_BLOCK = registerBlockWithoutBlockItem("instant_health_fluid_block", new MagicFluid(StatusEffects.INSTANT_HEALTH, ModFluids.INSTANT_HEALTH_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block INVISIBILITY_FLUID_BLOCK = registerBlockWithoutBlockItem("invisibility_fluid_block", new MagicFluid(StatusEffects.INVISIBILITY, ModFluids.INVISIBILITY_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block JUMP_BOOST_FLUID_BLOCK = registerBlockWithoutBlockItem("jump_boost_fluid_block", new MagicFluid(StatusEffects.JUMP_BOOST, ModFluids.JUMP_BOOST_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block LEVITATION_FLUID_BLOCK = registerBlockWithoutBlockItem("levitation_fluid_block", new MagicFluid(StatusEffects.LEVITATION, ModFluids.LEVITATION_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block LUCK_FLUID_BLOCK = registerBlockWithoutBlockItem("luck_fluid_block", new MagicFluid(StatusEffects.LUCK, ModFluids.LUCK_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block MINING_FATIGUE_FLUID_BLOCK = registerBlockWithoutBlockItem("mining_fatigue_fluid_block", new MagicFluid(StatusEffects.MINING_FATIGUE, ModFluids.MINING_FATIGUE_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block NAUSEA_FLUID_BLOCK = registerBlockWithoutBlockItem("nausea_fluid_block", new MagicFluid(StatusEffects.NAUSEA, ModFluids.NAUSEA_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block NIGHT_VISION_FLUID_BLOCK = registerBlockWithoutBlockItem("night_vision_fluid_block", new MagicFluid(StatusEffects.NIGHT_VISION, ModFluids.NIGHT_VISION_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block POISON_FLUID_BLOCK = registerBlockWithoutBlockItem("poison_fluid_block", new MagicFluid(StatusEffects.POISON, ModFluids.POISON_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block REGENERATION_FLUID_BLOCK = registerBlockWithoutBlockItem("regeneration_fluid_block", new MagicFluid(StatusEffects.REGENERATION, ModFluids.REGENERATION_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block RESISTANCE_FLUID_BLOCK = registerBlockWithoutBlockItem("resistance_fluid_block", new MagicFluid(StatusEffects.RESISTANCE, ModFluids.RESISTANCE_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block SATURATION_FLUID_BLOCK = registerBlockWithoutBlockItem("saturation_fluid_block", new MagicFluid(StatusEffects.SATURATION, ModFluids.SATURATION_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block SLOW_FALLING_FLUID_BLOCK = registerBlockWithoutBlockItem("slow_falling_fluid_block", new MagicFluid(StatusEffects.SLOW_FALLING, ModFluids.SLOW_FALLING_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block SLOWNESS_FLUID_BLOCK = registerBlockWithoutBlockItem("slowness_fluid_block", new MagicFluid(StatusEffects.SLOWNESS, ModFluids.SLOWNESS_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block SPEED_FLUID_BLOCK = registerBlockWithoutBlockItem("speed_fluid_block", new MagicFluid(StatusEffects.SPEED, ModFluids.SPEED_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block STRENGTH_FLUID_BLOCK = registerBlockWithoutBlockItem("strength_fluid_block", new MagicFluid(StatusEffects.STRENGTH, ModFluids.STRENGTH_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block VILLAGE_HERO_FLUID_BLOCK = registerBlockWithoutBlockItem("village_hero_fluid_block", new MagicFluid(StatusEffects.HERO_OF_THE_VILLAGE, ModFluids.VILLAGE_HERO_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block WATER_BREATHING_FLUID_BLOCK = registerBlockWithoutBlockItem("water_breathing_fluid_block", new MagicFluid(StatusEffects.WATER_BREATHING, ModFluids.WATER_BREATHING_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block WEAKNESS_FLUID_BLOCK = registerBlockWithoutBlockItem("weakness_fluid_block", new MagicFluid(StatusEffects.WEAKNESS, ModFluids.WEAKNESS_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
    public static final Block WITHER_FLUID_BLOCK = registerBlockWithoutBlockItem("wither_fluid_block", new MagicFluid(StatusEffects.WITHER, ModFluids.WITHER_FLUID_STILL, FabricBlockSettings.of(Material.WATER).noCollision().nonOpaque().dropsNothing()), ModItemGroup.MAGIC);
