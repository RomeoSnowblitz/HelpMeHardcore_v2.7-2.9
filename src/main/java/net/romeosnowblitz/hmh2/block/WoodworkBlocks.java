...
public class WoodworkBlocks {
    ...
    public static final Block BANANA_LEAVES = resisterBlock("banana_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.WOODWORKS);
    ...
    public static final Block BANANA_DOOR = resisterBlock("banana_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block BANANA_TRAPDOOR = resisterBlock("banana_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block BANANA_BUTTON = resisterBlock("banana_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block BANANA_PRESSURE_PLATE = resisterBlock("banana_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block BANANA_FENCE_GATE = resisterBlock("banana_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CHERRY_LEAVES = resisterBlock("cherry_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CHERRY_DOOR = resisterBlock("cherry_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block CHERRY_TRAPDOOR = resisterBlock("cherry_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block CHERRY_BUTTON = resisterBlock("cherry_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block CHERRY_PRESSURE_PLATE = resisterBlock("cherry_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CHERRY_FENCE_GATE = resisterBlock("cherry_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CORK_OAK_LEAVES = resisterBlock("cork_oak_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CORK_OAK_DOOR = resisterBlock("cork_oak_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block CORK_OAK_TRAPDOOR = resisterBlock("cork_oak_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block CORK_OAK_BUTTON = resisterBlock("cork_oak_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block CORK_OAK_PRESSURE_PLATE = resisterBlock("cork_oak_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block CORK_OAK_FENCE_GATE = resisterBlock("cork_oak_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block JACARANDA_LEAVES = resisterBlock("jacaranda_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.WOODWORKS);
    ...
    public static final Block JACARANDA_DOOR = resisterBlock("jacaranda_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block JACARANDA_TRAPDOOR = resisterBlock("jacaranda_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block JACARANDA_BUTTON = resisterBlock("jacaranda_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block JACARANDA_PRESSURE_PLATE = resisterBlock("jacaranda_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block JACARANDA_FENCE_GATE = resisterBlock("jacaranda_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block MANGO_LEAVES = resisterBlock("mango_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES)), ModItemGroup.WOODWORKS);
    ...
    public static final Block MANGO_DOOR = resisterBlock("mango_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block MANGO_TRAPDOOR = resisterBlock("mango_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block MANGO_BUTTON = resisterBlock("mango_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block MANGO_PRESSURE_PLATE = resisterBlock("mango_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block MANGO_FENCE_GATE = resisterBlock("mango_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block MAHOE_LEAVES = resisterBlock("mahoe_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES).nonOpaque()), ModItemGroup.WOODWORKS);
    ...
    public static final Block MAHOE_DOOR = resisterBlock("mahoe_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block MAHOE_TRAPDOOR = resisterBlock("mahoe_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block MAHOE_BUTTON = resisterBlock("mahoe_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block MAHOE_PRESSURE_PLATE = resisterBlock("mahoe_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block MAHOE_FENCE_GATE = resisterBlock("mahoe_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block WILLOW_LEAVES = resisterBlock("willow_leaves", new LeavesBlock(FabricBlockSettings.copy(Blocks.OAK_LEAVES).nonOpaque()), ModItemGroup.WOODWORKS);
    ...
    public static final Block WILLOW_DOOR = resisterBlock("willow_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block WILLOW_TRAPDOOR = resisterBlock("willow_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).nonOpaque()), ModItemGroup.WOODWORKS);
    public static final Block WILLOW_BUTTON = resisterBlock("willow_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f).noCollision()), ModItemGroup.WOODWORKS);
    public static final Block WILLOW_PRESSURE_PLATE = resisterBlock("willow_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
    ...
    public static final Block WILLOW_FENCE_GATE = resisterBlock("willow_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.0f)), ModItemGroup.WOODWORKS);
