...
public class WoodworkBlocks {
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {return ModConfiguredFeatures.BANANA_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {return ModConfiguredFeatures.CHERRY_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return ModConfiguredFeatures.CORK_OAK_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return ModConfiguredFeatures.JACARANDA_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return ModConfiguredFeatures.MANGO_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return ModConfiguredFeatures.MAHOE_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    @Override protected RegistryKey<ConfiguredFeature<?, ?>> getTreeFeature(Random random, boolean bees) {
        return ModConfiguredFeatures.WILLOW_KEY;}}, FabricBlockSettings.copy(Blocks.OAK_SAPLING).sounds(BlockSoundGroup.GRASS)), ModItemGroup.WOODWORKS);
    ...
    private static ButtonBlock createStoneButtonBlock() {
        return new ButtonBlock(AbstractBlock.Settings.of(Material.DECORATION).noCollision().strength(0.5F), BlockSetType.STONE, 20, false);
    }
