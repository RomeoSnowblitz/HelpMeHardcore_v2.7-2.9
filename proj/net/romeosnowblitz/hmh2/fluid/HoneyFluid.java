...
extends class_3609 {
    ...
    public void randomDisplayTick(class_1937 world, class_2338 pos, class_3610 state, Random random) {
        if (!state.method_15771() && !((Boolean)state.method_11654((class_2769)field_15902)).booleanValue()) {
            ...
            world.method_8406((class_2394)class_2398.field_20536, (double)pos.method_10263() + random.nextDouble(), (double)pos.method_10264() + random.nextDouble(), (double)pos.method_10260() + random.nextDouble(), 0.0, 0.0, 0.0);
        }
    }
    ...
    public class_2680 method_15790(class_3610 state) {
        return (class_2680)ModBlocks.HONEY_FLUID_BLOCK.method_9564().method_11657((class_2769)class_2404.field_11278, (Comparable)Integer.valueOf(HoneyFluid.method_15741((class_3610)state)));
    }
