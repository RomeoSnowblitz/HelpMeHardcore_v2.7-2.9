...
public class MultiPurposeHoneyBucket
extends class_1792
implements class_5633 {
    private final class_3611 fluid;
    private static final int MAX_USE_TIME = 32;

    public MultiPurposeHoneyBucket(class_3611 fluid, class_1792.class_1793 settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public class_1799 method_7861(class_1799 stack, class_1937 world, class_1309 user) {
        ...
        if (!world.field_9236) {
            ...
            user.method_6016(class_1294.field_16595);
            user.method_6016(class_1294.field_5908);
            user.method_6016(class_1294.field_5906);
            user.method_6016(class_1294.field_5912);
            user.method_6016(class_1294.field_5902);
        }
    ...
    public class_1271<class_1799> method_7836(class_1937 world, class_1657 user, class_1268 hand) {
        ...
        class_3965 blockHitResult = class_1755.method_7872((class_1937)world, (class_1657)user, (class_3959.class_242)(this.fluid == class_3612.field_15906 ? class_3959.class_242.field_1345 : class_3959.class_242.field_1348));
    ...
    public boolean method_7731(@Nullable class_1657 player, class_1937 world, class_2338 pos, @Nullable class_3965 hitResult) {
        ...
        boolean bl2 = blockState.method_26215() || bl || block instanceof class_2402 && ((class_2402)block).method_10310((class_1922)world, pos, blockState, this.fluid);
        boolean bl3 = bl2;
        if (!bl2) {
