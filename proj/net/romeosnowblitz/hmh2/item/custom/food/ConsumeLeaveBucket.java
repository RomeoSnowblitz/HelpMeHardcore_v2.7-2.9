...
public class ConsumeLeaveBucket
extends class_1792 {
    private static final int MAX_USE_TIME = 40;

    public ConsumeLeaveBucket(class_1792.class_1793 settings) {
        super(settings);
    }
    ...
    public class_1799 method_7861(class_1799 stack, class_1937 world, class_1309 user) {
        ...
        if (user instanceof class_1657 && !((class_1657)user).method_31549().field_7477) {
            class_1799 itemStack = new class_1799((class_1935)class_1802.field_8550);
