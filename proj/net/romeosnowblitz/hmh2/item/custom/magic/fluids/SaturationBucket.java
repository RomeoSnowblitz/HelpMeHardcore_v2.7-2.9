...
public class SaturationBucket
extends class_1792
implements class_5633 {
    private final class_3611 fluid;

    public SaturationBucket(class_3611 fluid, class_1792.class_1793 settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public class_1799 method_7861(class_1799 stack, class_1937 world, class_1309 user) {
        ...
        if (!world.field_9236) {
            user.method_6092(new class_1293(class_1294.field_5922, 200, 4));
        }
    ...
    public class_1271<class_1799> method_7836(class_1937 world, class_1657 user, class_1268 hand) {
        ...
        class_3965 blockHitResult = SaturationBucket.method_7872((class_1937)world, (class_1657)user, (class_3959.class_242)(this.fluid == class_3612.field_15906 ? class_3959.class_242.field_1345 : class_3959.class_242.field_1348));
        ...
        if (world.method_8505(user, blockPos) && user.method_7343(blockPos2, direction, itemStack)) {
            ...
            if (this.method_7731(user, world, blockPos3, blockHitResult)) {
                ...
                user.method_7259(class_3468.field_15372.method_14956((Object)this));
                return class_1271.method_29237((Object)SaturationBucket.getEmptiedStack(itemStack, user), (boolean)world.method_8608());
            }
            return class_1271.method_22431((Object)itemStack);
        }
        return class_1271.method_22431((Object)itemStack);
