...
implements GeoEntity {
    ...
    public MagmiteEntity(class_1299<? extends class_1588> entityType, class_1937 world) {
    ...
    public boolean method_6121(class_1297 target) {
        ...
        class_1293 statusEffectInstance = livingEntity.method_6112(CustomEffects.KINDLING);
        if (target instanceof class_1309) {
            int i = 1;
            if (statusEffectInstance != null) {
                i += statusEffectInstance.method_5578();
                livingEntity.method_6111(CustomEffects.KINDLING);
            } else {
                --i;
            }
            i = class_3532.method_15340((int)i, (int)0, (int)20);
            class_1293 statusEffectInstance2 = new class_1293(CustomEffects.KINDLING, 6000, i, false, false, true);
