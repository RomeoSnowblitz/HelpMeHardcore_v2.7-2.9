...
implements GeoEntity {
    ...
    public SculkmiteEntity(class_1299<? extends class_1588> entityType, class_1937 world) {
        super(entityType, world);
    }

    public static class_5132.class_5133 setAttributes() {
        return class_1321.method_26828().method_26868(class_5134.field_23716, 5.0).method_26868(class_5134.field_23721, 2.0).method_26868(class_5134.field_23723, 1.0).method_26868(class_5134.field_23719, (double)0.2f);
    }
    ...
    private PlayState predicate(AnimationState animationState) {
        if (animationState.isMoving()) {
            animationState.getController().setAnimation(RawAnimation.begin().then("animation.sculkmite.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
        animationState.getController().setAnimation(RawAnimation.begin().then("animation.sculkmite.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
    ...
    public boolean method_6121(class_1297 target) {
        ...
        class_1293 statusEffectInstance = livingEntity.method_6112(CustomEffects.SIGHTLESSSNESS);
        if (target instanceof class_1309) {
            int i = 1;
            if (statusEffectInstance != null) {
                i += statusEffectInstance.method_5578();
                livingEntity.method_6111(CustomEffects.SIGHTLESSSNESS);
            } else {
                --i;
            }
            i = class_3532.method_15340((int)i, (int)0, (int)20);
            class_1293 statusEffectInstance2 = new class_1293(CustomEffects.SIGHTLESSSNESS, 6000, i, false, false, true);
    ...
    protected void method_5712(class_2338 pos, class_2680 state) {
        this.method_5783(class_3417.field_15084, 1.0f, 1.0f);
    }
