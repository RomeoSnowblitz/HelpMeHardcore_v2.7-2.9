...
public class HellmiteEntity
extends class_1588
implements GeoEntity {
    private final AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache((GeoAnimatable)this);

    public HellmiteEntity(class_1299<? extends class_1588> entityType, class_1937 world) {
        super(entityType, world);
    }

    public static class_5132.class_5133 setAttributes() {
        return class_1321.method_26828().method_26868(class_5134.field_23716, 5.0).method_26868(class_5134.field_23719, (double)0.2f);
    }
    ...
    private PlayState predicate(AnimationState animationState) {
        if (animationState.isMoving()) {
            animationState.getController().setAnimation(RawAnimation.begin().then("animation.hellmite.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
        animationState.getController().setAnimation(RawAnimation.begin().then("animation.hellmite.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }

    public boolean method_6121(class_1297 target) {
        return target.method_5643(this.method_48923().method_48812((class_1309)this), 2.0f);
    }
