...
extends GeoEntityRenderer<SculkmiteEntity> {
    public SculkmiteRenderer(class_5617.class_5618 ctx) {
        super(ctx, (GeoModel)new SculkmiteModel());
    }

    public class_2960 getTextureLocation(SculkmiteEntity instance) {
        return new class_2960("hmh2", "textures/entity/sculkmite/sculkmite.png");
    }

    public class_1921 getRenderType(SculkmiteEntity animatable, class_2960 texture, @Nullable class_4597 bufferSource, float partialTick) {
