...
extends class_2248 {
    ...
    public BlockTwo(class_4970.class_2251 settings) {
        super(settings);
    ...
    public void method_9514(class_2680 state, class_3218 world, class_2338 pos, class_5819 random) {
        if (world.method_22347(pos.method_10084())) {
            ...
            if (i < 3) {
                ...
                if (j == 15) {
                    world.method_8501(pos.method_10084(), ModBlocks.BLOCK_THREE.method_9564());
    ...
    protected void update(class_1937 world, class_2338 pos) {
        if (this.absorbSouls(world, pos)) {
            world.method_8652(pos, ModBlocks.BLOCK_TWO.method_9564(), 2);
    ...
    private boolean absorbSouls(class_1937 world, class_2338 pos) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (class_2350 direction : class_2350.values()) {
                ...
                world.method_8652(blockPos2, ModBlocks.BLOCK_THREE.method_9564(), 3);
                ++i;
                if (j >= 0) continue;
            ...
            for (class_2350 direction : class_2350.values()) {
                blockPos2 = blockPos.method_10093(direction);
                blockState = world.method_8320(blockPos2);
                if (!blockState.method_27852(ModBlocks.BLOCK_ONE)) continue;
