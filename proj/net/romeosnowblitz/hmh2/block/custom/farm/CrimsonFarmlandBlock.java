...
public class CrimsonFarmlandBlock
extends class_2248 {
    ...
    public CrimsonFarmlandBlock(class_4970.class_2251 settings) {
        super(settings);
    ...
    public void method_9588(class_2680 state, class_3218 world, class_2338 pos, class_5819 random) {
        if (!state.method_26184((class_4538)world, pos)) {
            CrimsonFarmlandBlock.setToNylium(state, (class_1937)world, pos);
        }
    }

    public void method_9514(class_2680 state, class_3218 world, class_2338 pos, class_5819 random) {
        int i = (Integer)state.method_11654((class_2769)MOISTURE);
        if (CrimsonFarmlandBlock.isLavaNearby((class_4538)world, pos) || world.method_8520(pos.method_10084())) {
            if (i < 7) {
        ...
        } else if (!CrimsonFarmlandBlock.hasModCrop((class_1922)world, pos)) {
            CrimsonFarmlandBlock.setToNylium(state, (class_1937)world, pos);
        }
    }
    ...
    public static void setToNylium(class_2680 state, class_1937 world, class_2338 pos) {
        world.method_8501(pos, CrimsonFarmlandBlock.method_9582((class_2680)state, (class_2680)class_2246.field_22120.method_9564(), (class_1936)world, (class_2338)pos));
    }
